"""
Disclaimer:
This file contains the DDPG class, which is a custom DDPG algorithm for training reinforcement learning agents to trade stocks.
Code: This implementation borrows code from https://github.com/DLR-RM/stable-baselines3/blob/master/stable_baselines3/ddpg/ddpg.py
