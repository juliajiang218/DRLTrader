"""
Disclaimer: 
Nothing herein is financial advice, and NOT a recommendation to trade real money. Many platforms exist for simulated trading (paper trading) which can be used for building and developing the methods discussed. Please use common sense and always first consult a professional before trading or investing.
Setup Alpaca Paper trading environment

The following script is modified based on: https://github.com/AI4Finance-Foundation/FinRL/blob/master/finrl/meta/data_processors/processor_alpaca.py
"""
